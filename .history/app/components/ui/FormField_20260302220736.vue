...
const componentMap = { text: TextField, email: TextField, password: TextField, checkbox: CheckBoxField } as const
</script>

<template>
  <Field.Root class="field" :disabled="disabled" :required="required" :invalid="!!error">
    <Field.Label v-if="label && type !== 'checkbox'" class="field__label">
      {{ label }}
